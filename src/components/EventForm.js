...
const EventForm = ({}) => {
    ...
    const logsDoesNotExists = state.operationLogs.length === 0
    ...
    <h4>イベント作成フォーム</h4>
        <form>
            ...
            <button className='btn btn-danger' onClick={deleteAllOperationLogs} disabled={logsDoesNotExists}>すべての操作ログを削除する</button>
        </form>
    </>
    )
}
